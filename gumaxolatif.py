...
#          years  / month  /  day   
#          ساڵ     / مانگ     / رۆژ
if datetime.now().date() < datetime(2024, 7, 1).date():
    pass
else:
    sys.exit("The Tool Has been expired")
...
def menu():
    ...
    print('\x1b[38;5;52m[ 1 ] 𝘾𝙍𝘼𝘾𝙆 𝙁𝙄𝙇𝙀')
...
def setting():
    ...
    hu = input('\x1b[1;33m[3]  RANDOM FAEBOOK  [SLOW]')
    if hu in ['1','01']:
    ...
    #print("\033[1;37m[ 2 ] FREE")
    #print(f"\x1b[1;92m╍╌╍╌╍\x1b[1;95m‒╍╌╍╌╍‒\x1b[1;94m╍╌╍╌╍\x1b[1;97m╌╍╌╍╍\x1b[1;96m╌╍╌╍‒╍\x1b[1;93m╌╍╌╍‒╍\x1b[1;91m╌╍╌╍╌╍\x1b[1;92m╌╍╌╍╌╍")
    hc = input('\x1b[38;5;166m[ 1 ] METHOD NEW🖤')
    if hc in ['1','01']:
