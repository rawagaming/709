# Modul
#بەخێربەی بەرێزم 
#agar am toola ba open brddt nawm bhena🤩❤
#DATE 2024/6/14
import hashlib
import requests
import sys
...
def banner():
	...
	masud(f'''
         ...
         ;:::::'   :;                         
        ;:::::;     ;.                        
       ,:::::'  \033[1;91m𝜭 \033[1;91m 𝜭\x1b[38;5;48m ;           OOO\         
       ::::::;       ;          OOOOO\        
       ;:::::;       ;         OOOOOOOO       
      ,;::::::;     ;'         / OOOOOOO      
    ;:::::::::`. ,,,;.        /  / DOOOOOO    
...
`:`:::::::`;:::::: ;::::::#/               DOO
 ...
 `:::::`::::::::::::;'`:;::#                O 
  `:::::`::::::::;' /  / `:#                  
   ::::::`:::::;'  /  /   `#            
√✔ 𝑻𝑶𝑶𝑳 𝑩𝒀 RUSSI
√✔ 𝑻𝑬𝑳𝑬𝑮𝑹𝑨𝑴 @kurd_kurd120
√✔ 𝘾𝙝𝙖𝙣𝙖𝙡. @TOOLS_TERMUX1
''')
# LOGIN
def login():
	try:
...
''')
	print("\033[1;32m➣ \033[1;32m TOTAL ID : "+str(len(id)))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r\033[1;32m  [ SC-RUSSI ]  {P}{b}{loop}{P}//{b}{len(id)}{P} [OK➳]{P}{H}{ok}{P} ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})"),
	sys.stdout.flush()
...
def cek_NIK(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[32m              RUSSI➛ %s%s"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[93m              RUSSI➛ %s"%(P,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
