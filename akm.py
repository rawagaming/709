...
def menu(id):
	...
	print('[\x1b[1;33m 2 ]CRACK FILE ')

	#print('\x1b[1;93m[\x1b[1;92m+\x1b[1;93m]\x1b[1;93m ╰─>\x1b[1;92m0. Keluar ')

	_____alvino__adijaya_____ = input(' HALBZHERA ')
...
def setting():
	...
	print('\x1b[38;5;48m [ 3 ] RANDOM FB')
	...
	print('\x1b[38;5;13[1] METHOD + D.facebook.com')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{x}[{P}+{x}]{k}[RAWA] ╰─>{Z}[{N}{loop}{K}/{x}{len(id)}{kk}]—{hh}[{B}{ok}{m}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
