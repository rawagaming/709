...
os.system('clear')
print(logo)
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m 𝐍𝐀𝐖𝐓 𝐂𝐇𝐘𝐀➡️ \033[1;91m: \33[1;32m')
pass
def login():
    try:
...
def menu():
    os.system('clear')
    print(logo)
    print(f"\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92m𝐍𝐀𝐖𝐓➡️\033[1;91m :\033[1;96m "+uname)
    print("\033[97;1m[\033[92;1m•\033[97;1m] \033[0;93m𝐑𝐨𝐳𝐡➡️ :\033[1;92m "+date)
    print('\033[0;92m===============================================')
    print(f"""\033[97;1m[\033[92;1m1\033[97;4m] \033[0;92m𝐂𝐑𝐀𝐂𝐊 𝐅𝐈𝐋𝐄[𝐁𝐄𝐒𝐓]🔥         """)
    print(f"""\033[97;1m[\033[92;1m2\033[97;1m] \033[92;1m𝐂𝐏 𝐔 𝐎𝐊𝐘𝐀𝐊𝐀𝐍   """)
    print("""\033[97;1m[\033[92;1m0\033[97;1m] \033[0;91m𝐃𝐀𝐑𝐂𝐇𝐔𝐍""")
    print('\033[0;92m================')
...
def result():
    ...
    if kz in ['1','01']:
        try:vin = os.listdir('CP')
            ...
            print('\033[0;91m==================')
            animation(' \033[97;1m[\033[92;1m•\033[97;1m] FILE HALAYA👁 ')
            time.sleep(3)
            back()
        if len(vin)==0:
            print('\033[0;91m==================')
...
def setting():
    ...
    print("\033[97;1m[\033[92;1m3\033[97;1m] [𝐕𝐈𝐏] \x1b[33m[3\x1b[33m] \x1b[33m[\033[0;92m \x1b[36mRANDOM🐾����x1b[33m]")
    print('\033[0;92m=============================')
