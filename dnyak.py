...
def menu():
	...
	_IPYTHONI_(f'\x1b[1;96m1- CRACK BA FILE')
...
def Settings():
	...
	print(f'\x1b[1;91m[ 1 ] METHOD M.FACEBOOK.COM')
	hc = input('\x1b[1;96mSELECT :\x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;91m[A] ALL PASSWORD🙂')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	#print(f"\x1b[1;97m------------------------------------------------------------")
	#print(f"\x1b[1;97m[+] TARIX : \x1b[1;97m{ha}\x1b[1;97m/\x1b[1;97m{bu}\x1b[1;97m/\x1b[1;97m{ta} ")
	#print(f"\x1b[1;97m------------------------------------------------------------")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (HaWa🙂) {P}{b}{loop}{P}•{b}{len(id)}{N}  + OK:{P}{H}{ok}{K} •  CP:{Z}{sir}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
