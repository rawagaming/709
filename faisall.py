...
os.system('clear')
os.system('espeak -a 300 " Welcome,   to,  KIILER,  NEW,  UPDATE"')
os.system('clear')
...
def setting():
	...
	print('')
	print('')
	pwplus=input(f' \x1b[38;5;98m Crack all pasward tool [ 1 ] = ')
	print('')
	if pwplus in ['1','01']:
		pwpluss.append('ya')
		pwku=input(f' \x1b[38;5;98m CRACK ALL NET WORK [ X ] = ')
		print('')
		pwkuh=pwku.split('x,X')
		for xpw in pwkuh:
			pwnya.append(xpw)
	else:
		pwpluss.append('no')
