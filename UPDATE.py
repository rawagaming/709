...
###         ########  ########## ########### ########  ##########
\x1b[38;5;57m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [WORKING ONLY KOREK⬇⬆ DATA]         \033[0;92m \x1b[38;5;57m║
\x1b[38;5;57m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝ """%(P))
os.system('clear')
banner()
#MENU
...
def Settings():
	...
	print(f'\033[1;96m[\033[1;33m1\033[1;96m]\033[0;92m〚FACEBOOK NEW+OLD〛')
...
def BB():
    ...
    passwrd()
def passwrd():
	print('\x1b[38;5;224m╠══≫ Total ids\x1b[38;5;224m',str(len(id)))                                                                 
	print("""%s\x1b[38;5;48m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
╠══Author            ◉⁠ PLC-PATHER PASSWORD    ║ 
╠══Telegram          ◉⁠ Police_501             ║    
╠══Github            ◉⁠ PLC_501X_44            ║   
╠══Tools             ◉⁠ Paid 15 $              ║    
╠══Version           ◉⁠ 4.1 ]                  ║ 
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r🅟🅞🅛🅘🅒🅔 \033[1;37m{Z}{b}{loop}{Z}◍⁠{b}{len(id)} \x1b[38;5;43m[\x1b[38;5;48mOK∙{ok}\x1b[38;5;43m]{bo} {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
...
def cek_POLICE(kuki):
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \x1b[38;5;48m              ➛ %s%s\x1b[38;5;48m"%(H,H,game[i].replace("\x1b[38;5;48mDitambahkan pada","\x1b[38;5;48m Ditambahkan pada")))
	...
	try:
		for i in range(len(game)):
			print ("\r%s  \x1b[1;93m              ➛ %s"%(K,game[i].replace("Kedaluwarsa"," Kedaluwarsa")))
	except AttributeError:
