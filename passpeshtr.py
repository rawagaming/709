...
def menu():
	...
	banner()
	print('')
	print(' \033[1;95m[ 1 ] CRACK FILE [ ON ] ')
	print('')
	print(' \033[1;91m[ 2 ] CRAETE FILE [ OFF🦦 ] ')
	print('')
	SALE = input(' \033[1;93m└──HALBZHERA = ')
	if SALE in ['1','01']:
		FILE()
	if SALE in ['2','02']:
		DUMP()
...
def setting():
	os.system('clear')
	banner()
	print(' \033[1;91mID NEW [ 1 ] = ')
	print('')
	print(' \033[1;94mID OLD [ 2 ] = ')
	print('')
	print(' \033[1;95mID RANDOM [ 3 ] = ')
	print('')
	hu = input(' \033[1;95m└──HALBZHERA = ')
	print('')
	if hu in ['1','01']:
...
def crack(idf,pwv):
	...
	fff = '%'
	sys.stdout.write(f"\r \x1b[1;96m[  \x1b[1;95m  \x1b[1;96m{loop}\x1b[1;90m＋\x1b[1;96m{len(id)}  \x1b[1;96mOK:{ok}  \x1b[1;96mCP:{cp}  ]"),
	sys.stdout.flush()
